    ...
    for process in cfg["processes"]:
      ...
      for process in new_processes:
        ...
        if process.is_signal:
          has_signal = True
          #yumeng:
          #process. param defined in process.py as a dict, eg {"mass": 500}, {"kl": 1.0, "kt": 1.0}
      ...
      for subp in process.subprocesses:
        ...
        if unc_value != None:
          ...
          if isinstance(unc_value, dict):
            #yumeng:?getUncertaintyForProcess defines values(relative factor) from yaml, symmetric case.
